...
- [Опис таблиць](#опис-таблиць)
- [Зв'язки та кардинальність](#звязки-та-кардинальність)
- [Типи даних](#типи-даних)
- [Пояснення проєктних рішень](#пояснення-проєктних-рішень)
- [Стики з іншими модулями](#стики-з-іншими-модулями)

---

## Огляд модуля

Мій внесок — два під-модулі, що є «фундаментом» системи: керування доступом і клієнти.
На них спираються інші командні модулі (замовлення, резервації, персонал).

| Під-модуль | Таблиці | Призначення |
|---|---|---|
...
> має складений первинний ключ із двох зовнішніх ключів. PDF-версія — у `diagram/`.
...
Первинний ключ **складений** `(role_id, right_id)` — забороняє дублювати пару.
