...
- **Ролі ≠ посади.** `roles` — це ролі *доступу* (права в застосунку), а не посади
  працівників. Посади розташовані у таблиці "ПОСАДИ ПРАЦІВНИКІВ" (модуль «Персонал»). Відповідальна - Відповідальна — [@Mariia5palamariuk](https://github.com/Mariia5palamariuk).
